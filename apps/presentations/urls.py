...
urlpatterns = [
    ...
    path("<uuid:pk>/title/", presentation_views.presentation_update_title, name="update-title"),
    path("<uuid:pk>/agent/", presentation_views.presentation_agent, name="agent"),
    ...
    path("<uuid:presentation_pk>/slides/<uuid:pk>/update/", slide_views.slide_update, name="slide-update"),
    path("<uuid:presentation_pk>/slides/<uuid:pk>/ai-edit/", slide_views.slide_ai_edit, name="slide-ai-edit"),
